...
export const statusConfig: Record<Status, { label: string }> = {
  concluido: { label: "✓ Concluído" },
  progresso: { label: "▶ Em progresso" },
};
...
export const modules: Module[] = [
  {
    ...
    status: "concluido",
    icon: <EmailIcon sx={{ fontSize: 18, color: "inherit" }} />,
    align: "left",
  },
  {
    number: "Módulo 02",
    ...
    status: "concluido",
    icon: <BarChartIcon sx={{ fontSize: 18, color: "inherit" }} />,
    align: "right",
  },
  {
    number: "Módulo 03",
    ...
    status: "concluido",
    icon: <GroupsIcon sx={{ fontSize: 18, color: "inherit" }} />,
    align: "left",
  },
  {
    number: "Módulo 04",
    ...
    status: "progresso",
    icon: <TrendingUpIcon sx={{ fontSize: 18, color: "inherit" }} />,
    align: "right",
  },
];
