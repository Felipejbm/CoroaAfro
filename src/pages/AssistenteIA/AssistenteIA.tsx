    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography
            sx={{ px: 2.5, pb: 1, fontSize: "0.72rem", opacity: 0.55 }}
          >
            SUAS CONVERSAS
          </Typography>
          <Stack sx={{ overflowY: "auto", px: 1.25, pb: 2, gap: 0.5 }}>
            ...
            {!carregando && conversas.length === 0 && (
              <Typography
                sx={{ px: 1.5, py: 2, fontSize: "0.78rem", opacity: 0.58 }}
              >
        ...
        <Stack component="main" sx={{ flex: 1, minWidth: 0, minHeight: 0 }}>
          ...
          >
            <Stack direction="row" alignItems="center" gap={1.5}>
              <Avatar
                sx={{ bgcolor: "primary.main", color: "secondary.light" }}
              >
          ...
          <Stack sx={{ height: "calc(100% - 73px)", overflow: "hidden" }}>
            <Stack
              sx={{ flex: 1, overflowY: "auto", px: { xs: 2, md: 5 }, py: 3 }}
            >
              {erro && (
              ...
              {carregando ? (
                ...
                <Stack
                  alignItems="center"
                  sx={{ maxWidth: 880, mx: "auto", pt: { xs: 2, md: 5 } }}
                >
                  <Box
                    sx={{
                      width: 70,
                  ...
                  >
                    Escolha um tipo de ajuda ou escreva livremente. A assistente
                    considera seus dados cadastrados, metas, trilhas e
                    Instagram.
                  </Typography>
                  <Box
                    sx={{
                  ...
                  >
                    {modos
                      .filter((item) => item.id !== "geral")
                      .map((item) => (
                        <Button
                          key={item.id}
                          onClick={() => {
                            setModo(item.id);
                            setTexto(item.sugestao);
                          }}
                          sx={{
                            display: "block",
                            textAlign: "left",
                  ...
                  {mensagens.map((mensagem) => {
                    ...
                    return (
                      <Stack
                        ...
                        direction="row"
                        justifyContent={usuario ? "flex-end" : "flex-start"}
                        gap={1.2}
                      >
                        {!usuario && (
                          <Avatar
                        ...
                        <Stack
                          sx={{
                            ...
                            alignItems: usuario ? "flex-end" : "flex-start",
                          }}
                        >
                          <Box
                            sx={{
                              bgcolor: usuario ? "primary.main" : "#fff",
                              color: usuario
                                ? "secondary.light"
                                : "text.primary",
                              px: 2,
                              py: 1.5,
                              borderRadius: usuario
                                ? "18px 18px 4px 18px"
                                : "4px 18px 18px 18px",
                              boxShadow: `0 7px 18px ${alpha(theme.palette.primary.dark, 0.08)}`,
                            }}
                          >
                            <Typography
                              sx={{
            ...
            <Stack
              sx={{
                ...
                pb: 2.5,
                pt: 1.5,
                bgcolor: alpha(theme.palette.secondary.light, 0.96),
              ...
              <Stack sx={{ width: "100%", maxWidth: 900, mx: "auto", gap: 1 }}>
                  ...
                  {modos.map((item) => (
                    <Button
                      ...
                      sx={{
                        ...
                        color:
                          modo === item.id ? "secondary.light" : "primary.main",
                        fontSize: "0.72rem",
                        "&:hover": {
                          bgcolor:
                            modo === item.id
                ...
                <Stack
                  ...
                  sx={{
                    ...
                    borderRadius: 3,
                    p: 1,
                    boxShadow: `0 10px 28px ${alpha(theme.palette.primary.dark, 0.08)}`,
                  }}
                >
                  <TextField
                    fullWidth
                    ...
                    disabled={enviando}
                    placeholder={
                      modoAtivo?.sugestao ?? "Escreva sua pergunta..."
                    }
                    ...
                    slotProps={{
                      input: {
                        ...
                        sx: { px: 1, py: 0.7, fontSize: "0.9rem" },
                      },
                    }}
                  />
                  <IconButton
                ...
                >
                  A Coroa IA pode cometer erros. Confira informações importantes
                  antes de agir.
                </Typography>
              </Stack>
            </Stack>
